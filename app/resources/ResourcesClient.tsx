            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="bg-white rounded-3xl shadow-xl overflow-hidden animate-on-scroll">
                <div className="p-12 text-center">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">{d.blogHeading}</h3>
                  <p className="text-gray-600 text-lg leading-relaxed max-w-2xl mx-auto mb-8">{d.blogText}</p>
              ...
              <div className="bg-white rounded-3xl shadow-xl overflow-hidden animate-on-scroll mt-8">
                <div className="p-12 text-center">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">{d.podcastHeading}</h3>
                  <p className="text-gray-600 text-lg leading-relaxed max-w-2xl mx-auto mb-8">{d.podcastText}</p>
