...
export default function NotFound() {
  return (
    <section className="page-hero bg-gradient-to-br from-oxford via-[#1a2d50] to-azure text-center">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-2xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl heading-primary text-white font-dancing font-bold mb-6 leading-tight">
