                ...
                <div key={s.title} className={`grid lg:grid-cols-2 gap-12 items-center ${i % 2 === 1 ? 'lg:flex-row-reverse' : ''} animate-on-scroll`}>
                  ...
                  <div className={`space-y-6 ${i % 2 === 1 ? 'lg:order-1' : ''}`}>
                    ...
                    <p className="text-gray-600 text-lg leading-relaxed">
                      {s.title === 'Clarity Coaching' && "If you feel stuck, lost, or like you're going through the motions — this programme is for you. We'll work together to uncover what you truly want and build the courage to go after it."}
                      {s.title === 'Career Coaching' && "If your career isn't lighting you up or you're at a crossroads professionally — this programme is for you. We'll get you clear, confident, and ready to take decisive action."}
                      {s.title === 'Numerology for Clarity' && "If you need fast, focused insight and want a different perspective on your life's questions — this session is for you. Perfect when you need clarity but aren't ready for a longer coaching commitment."}
                    </p>
