...
const sessionIncludes = [
  '1-hour personalised numerology session (via video call)',
  'Your Life Path, Expression, and Soul Urge number analysis',
  'Personal Year cycle reading for actionable timing insights',
  'Relationship compatibility overview',
  'Q&A — bring your specific questions for focused clarity',
  'Follow-up notes summarising your key insights',
]
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-20">
          <div className="max-w-4xl mx-auto text-center py-32">
            <span className="inline-block text-carrot font-semibold text-sm uppercase tracking-widest mb-6 animate-on-scroll">Vedic Numerology Session</span>
            <h1 className="text-5xl md:text-6xl lg:text-7xl heading-primary text-white mb-6 leading-tight font-dancing font-bold animate-on-scroll">
              Numerology for Clarity
            </h1>
            <p className="text-2xl md:text-3xl text-carrot font-semibold mb-4 animate-on-scroll">
              Get answers fast, and find your focus
            </p>
            <p className="text-lg md:text-xl text-white/80 mb-10 max-w-2xl mx-auto leading-relaxed animate-on-scroll">
              Invaluable insight into your life choices, backed by ancient vedic practices
            </p>
            <BookingButton label="Get my numerology insights" className="btn-azure text-lg px-10 py-4 button-text transform hover:scale-105 transition-all duration-300 animate-on-scroll" />
          </div>
        </div>
            ...
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-16 animate-on-scroll">
                <h2 className="text-4xl md:text-5xl heading-secondary text-gray-900 mb-6">
                  What is <span className="text-carrot font-bold">Vedic Numerology</span>?
                </h2>
                <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
                  Vedic Numerology is an ancient system that uses the numbers in your birth date and name to reveal deep truths about your personality, life purpose, and the timing of key events in your life.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-16">
                <div className="bg-white rounded-2xl p-8 shadow-lg animate-on-scroll">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Vedic Numerology is rooted in ancient Indian mathematics and astrology, providing a more nuanced understanding of your numbers and their influence on your life journey.
                  </p>
                </div>
                <div className="bg-white rounded-2xl p-8 shadow-lg animate-on-scroll">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">The power of numbers</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Every number carries a specific vibration that influences different areas of life. Understanding your numbers can bring remarkable clarity to situations that once felt confusing or stuck.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 relative">
          <div className="container mx-auto px-6 relative z-10 text-center">
            <h2 className="text-4xl md:text-5xl heading-secondary text-gray-900 mb-6 animate-on-scroll">
              Ready for <span className="text-carrot font-bold">clarity</span>?
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8 animate-on-scroll">
              Book your personalised Numerology for Clarity session today.
            </p>
            <BookingButton label="Book My Numerology Session" className="btn-azure text-lg px-10 py-4 button-text animate-on-scroll" />
          </div>
        </section>
      </div>
    </>
