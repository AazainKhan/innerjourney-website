  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({ ...data, form_type: 'contact' }),
      })
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl body-text-light text-white/90 mb-8 leading-relaxed max-w-3xl mx-auto">
              Ready to start? I&apos;m here to support you every step of the way. Let&apos;s discuss how we can work together.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-4xl md:text-5xl heading-secondary text-gray-900 mb-6">
                  Start Your <span className="text-carrot font-bold">Journey</span> Today
                </h2>
                <p className="text-xl text-gray-600 leading-relaxed mb-8">
                  I&apos;m excited to learn about your goals and explore how we can work together to create the transformation you&apos;re seeking.
                </p>
              </div>

              <div className="space-y-6">
                {[
                  { icon: 'fa-envelope', title: 'Email', text: 'info@innerjourney-with-shanila.com' },
                  { icon: 'fa-phone', title: 'Phone', text: '+44 7387 973 382' },
                  { icon: 'fa-video', title: 'Video Sessions', text: 'Zoom, Google Meet, or your preferred platform' },
                  { icon: 'fa-map-marker-alt', title: 'Location', text: 'Leeds, United Kingdom' },
                ].map((item) => (
              ...
              <div className="mt-8">
                <BookingButton label="Book A Free Clarity Call" className="btn-azure button-text px-8 py-4" />
              </div>
            </div>
